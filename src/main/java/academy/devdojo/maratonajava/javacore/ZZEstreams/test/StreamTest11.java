...
public class StreamTest11 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lightNovels.stream().mapToDouble(LightNovel::getPrice).average().getAsDouble());
        System.out.println(lightNovels.stream().collect(Collectors.averagingDouble(LightNovel::getPrice)));

        //Tudo o que foi feito até o momento está dentro do objeto retornado pelo método summarizing e suas variantes
