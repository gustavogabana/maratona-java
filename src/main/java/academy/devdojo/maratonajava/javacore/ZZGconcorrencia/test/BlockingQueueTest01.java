...
public class BlockingQueueTest01 {
    public static void main(String[] args) throws InterruptedException {
        // Bounded: com limite de valor
        // Se colocar acima do valor, a thread fica bloqueada esperando liberar o espaço
        BlockingQueue<String> bq = new ArrayBlockingQueue<>(1);
        bq.put("William");
        System.out.printf("%s added %s%n", Thread.currentThread().getName(), bq.peek());
