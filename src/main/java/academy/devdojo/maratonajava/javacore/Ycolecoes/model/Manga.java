...
public class Manga implements Comparable<Manga> {
    ...
    public int compareTo(Manga outroManga) {
        // retorna negativo se este objeto(this) for < outroManga
...
//            return 1;
//        }
        // return this.id.compareTo(outroManga.getId()); // Delega a resposabilidade para o compareTo do wrapper Long
